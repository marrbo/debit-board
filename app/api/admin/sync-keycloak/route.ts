 ...
 *
 * Este endpoint expõe a operação post em /api/admin/sync-keycloak.
 *
 * @summary Cria recurso do endpoint /api/admin/sync-keycloak
 * @tags Admin, Sync Keycloak
 * @route POST /api/admin/sync-keycloak
 * @async
 * @function POST
 * @access admin
