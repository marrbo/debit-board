...
export default function AzureSearchCodePage() {
  ...
  return (
    <div className="w-full mx-auto px-6 py-6 lg:py-8 lg:px-8 space-y-6">
      ...
      {warning && (
        <div className="bg-amber-900/30 border border-amber-700/40 rounded-lg p-4 text-amber-200 text-sm flex items-start gap-3">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <div className="bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-lg p-5 shadow-sm hover:drop-shadow-lg">
      ...
      {items.length > 0 && (
        <div className="mt-4 text-right text-xs text-slate-500">
          ...
          <strong className="text-slate-300">{items.length}</strong>
        </div>
      )}
