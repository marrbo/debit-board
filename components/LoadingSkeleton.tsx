  ...
  return (
    <div className="w-full space-y-4 animate-pulse">
      ...
      <div className="flex items-center justify-between py-2">
        ...
        <div className="h-9 w-32 bg-brand/20 rounded-xl" />
      </div>

      {/* Card da tabela */}
      <div className="w-full bg-surface dark:bg-surface border border-default dark:border-strong rounded-2xl overflow-hidden shadow-sm hover:drop-shadow-lg">
        {/* Cabeçalho da tabela */}
        <div className="flex items-center gap-4 px-4 py-3 bg-apple-tertiary-light/10 dark:bg-apple-tertiary-dark/20 border-b border-default dark:border-strong">
        ...
        {Array.from({ length: 5 }).map((_, index) => (
          ...
          >
            ...
            <div className="ml-auto flex gap-2">
              <div className="h-7 w-20 bg-brand/20 rounded-xl" />
