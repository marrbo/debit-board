...
export default function ObservationDrawer({
  ...
  return (
    <div
      className={`fixed inset-0 -top-6 z-[9999] flex justify-end ${
        isOpen ? "pointer-events-auto" : "pointer-events-none"
      }`}
    >
      <div
        className={`absolute inset-0 -top-6 bg-black/60 transition-opacity duration-300 ${
            ...
            <>
              ...
              <div className="border-t border-gray-800 pt-4">
                ...
                <AssigneeSelect
                  users={users}
                  value={assignedTo}
                  onChange={(value) => onUpdateAssignee(_id.toString(), value)}
                />
              </div>
            </>
          ) : (
