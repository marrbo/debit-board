...
> **Exemplo:** `category:"Broken Access Control"` (busca por observations exatamente com essa categoria).
...
| `status` | Status atual do ciclo de vida da Issue. | `new`, `open`, `resolved`, `recurring`, `wont_fix` | `status:open` |
